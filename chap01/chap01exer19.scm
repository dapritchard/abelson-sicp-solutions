...
;; state variables a and b in the `fib-iter' process of section 1.2.2: a <- a +
;; b and b <- a.  Call this transformation T, and observe that applying T over
;; and over again n times, starting with 1 and 0, produces the pair _Fib_(n + 1)
;; and _Fib_(n).  In other words, the Fibonacci numbers are produced by applying
...
;; transformations T_(pq), where T_(pq) transforms the pair (a,b) according to a
